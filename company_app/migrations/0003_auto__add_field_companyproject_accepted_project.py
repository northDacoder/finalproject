...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyProject.accepted_project'
        db.add_column(u'company_app_companyproject', 'accepted_project',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='company_pick', unique=True, null=True, to=orm['developer_app.DeveloperProject']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyProject.accepted_project'
        db.delete_column(u'company_app_companyproject', 'accepted_project_id')
