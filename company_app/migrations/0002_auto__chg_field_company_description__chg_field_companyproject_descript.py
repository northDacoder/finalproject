...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'company_app_company', 'description', self.gf('django.db.models.fields.TextField')(max_length=6000))

        # Changing field 'CompanyProject.description'
        db.alter_column(u'company_app_companyproject', 'description', self.gf('django.db.models.fields.TextField')(max_length=6000))

    def backwards(self, orm):

        # Changing field 'Company.description'
        db.alter_column(u'company_app_company', 'description', self.gf('django.db.models.fields.CharField')(max_length=6000))

        # Changing field 'CompanyProject.description'
        db.alter_column(u'company_app_companyproject', 'description', self.gf('django.db.models.fields.CharField')(max_length=6000))
