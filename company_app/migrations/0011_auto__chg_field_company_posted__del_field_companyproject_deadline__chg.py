...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.posted'
        db.alter_column(u'company_app_company', 'posted', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'CompanyProject.deadline'
        db.delete_column(u'company_app_companyproject', 'deadline')


        # Changing field 'CompanyProject.created'
        db.alter_column(u'company_app_companyproject', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Company.posted'
        db.alter_column(u'company_app_company', 'posted', self.gf('django.db.models.fields.DateField')(auto_now=True))
        # Adding field 'CompanyProject.deadline'
        db.add_column(u'company_app_companyproject', 'deadline',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CompanyProject.created'
        db.alter_column(u'company_app_companyproject', 'created', self.gf('django.db.models.fields.DateField')(auto_now=True))
