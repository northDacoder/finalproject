...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'company_app_company', 'phone', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):

        # Changing field 'Company.phone'
        db.alter_column(u'company_app_company', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
