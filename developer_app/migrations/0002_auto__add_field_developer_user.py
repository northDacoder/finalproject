...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Developer.user'
        db.add_column(u'developer_app_developer', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Developer.user'
        db.delete_column(u'developer_app_developer', 'user_id')
