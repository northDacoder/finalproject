...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'developer_app_developer', 'email', self.gf('django.db.models.fields.EmailField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Developer.email'
        db.alter_column(u'developer_app_developer', 'email', self.gf('django.db.models.fields.URLField')(max_length=1000))
