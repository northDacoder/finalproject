...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Developer.phone'
        db.alter_column(u'developer_app_developer', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=14, null=True))

    def backwards(self, orm):

        # Changing field 'Developer.phone'
        db.alter_column(u'developer_app_developer', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True))
    ...
    models = {
        ...
        u'developer_app.developer': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'phone': ('django.db.models.fields.IntegerField', [], {'max_length': '14', 'null': 'True'}),
            'posted': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'screenshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
