...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'developer_app_developer', (
            ...
            ('age', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ...
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=14, null=True)),
