...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Developer.phone'
        db.add_column(u'developer_app_developer', 'phone',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Developer.phone'
        db.delete_column(u'developer_app_developer', 'phone')
