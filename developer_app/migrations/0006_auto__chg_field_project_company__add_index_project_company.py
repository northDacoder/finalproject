...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'developer_app_project', 'company', 'company_id')
        # Changing field 'Project.company'
        db.alter_column(u'developer_app_project', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['company_app.Company']))
        # Adding index on 'Project', fields ['company']
        db.create_index(u'developer_app_project', ['company_id'])


    def backwards(self, orm):
        # Removing index on 'Project', fields ['company']
        db.delete_index(u'developer_app_project', ['company_id'])


        # Renaming column for 'Project.company' to match new field type.
        db.rename_column(u'developer_app_project', 'company_id', 'company')
        # Changing field 'Project.company'
        db.alter_column(u'developer_app_project', 'company', self.gf('django.db.models.fields.CharField')(max_length=1000))
