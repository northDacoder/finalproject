...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Developer.website'
        db.delete_column(u'developer_app_developer', 'website')


        # Changing field 'Developer.posted'
        db.alter_column(u'developer_app_developer', 'posted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Adding field 'Developer.website'
        db.add_column(u'developer_app_developer', 'website',
