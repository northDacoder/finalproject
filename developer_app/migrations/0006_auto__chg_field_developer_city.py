...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Developer.city'
        db.alter_column(u'developer_app_developer', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Developer.city'
        raise RuntimeError("Cannot reverse this migration. 'Developer.city' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Developer.city'
        db.alter_column(u'developer_app_developer', 'city', self.gf('django.db.models.fields.CharField')(max_length=100))
