...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'developer_app_project', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('developer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='developer', to=orm['developer_app.Developer'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='company', to=orm['company_app.Company'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
