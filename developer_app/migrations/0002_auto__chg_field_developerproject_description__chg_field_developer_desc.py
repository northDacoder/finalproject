...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'developer_app_developerproject', 'description', self.gf('django.db.models.fields.TextField')(max_length=6000))

        # Changing field 'Developer.description'
        db.alter_column(u'developer_app_developer', 'description', self.gf('django.db.models.fields.TextField')(max_length=6000))

    def backwards(self, orm):

        # Changing field 'DeveloperProject.description'
        db.alter_column(u'developer_app_developerproject', 'description', self.gf('django.db.models.fields.CharField')(max_length=6000))

        # Changing field 'Developer.description'
        db.alter_column(u'developer_app_developer', 'description', self.gf('django.db.models.fields.CharField')(max_length=6000))
    ...
    models = {
        ...
        u'developer_app.developer': {
            ...
            'cover': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '6000'}),
            'email': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            'github': ('django.db.models.fields.URLField', [], {'max_length': '1000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
