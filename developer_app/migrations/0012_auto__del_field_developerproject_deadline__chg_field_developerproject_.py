...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeveloperProject.deadline'
        db.delete_column(u'developer_app_developerproject', 'deadline')


        # Changing field 'DeveloperProject.created'
        db.alter_column(u'developer_app_developerproject', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Developer.posted'
        db.alter_column(u'developer_app_developer', 'posted', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Adding field 'DeveloperProject.deadline'
        db.add_column(u'developer_app_developerproject', 'deadline',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'DeveloperProject.created'
        db.alter_column(u'developer_app_developerproject', 'created', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Developer.posted'
        db.alter_column(u'developer_app_developer', 'posted', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        u'company_app.company': {
            ...
            'posted': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
